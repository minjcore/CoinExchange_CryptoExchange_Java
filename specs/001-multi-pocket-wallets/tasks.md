...
- [X] T006 [P] Register `WALLET_POCKET_DEF_INVALID`, `WALLET_POCKET_EXISTS`, `WALLET_POCKET_NOT_EMPTY`, `WALLET_INVALID_TRANSFER` in `core.shared` ErrorCode (per `spec/foundation.md` §4.3 error table)
