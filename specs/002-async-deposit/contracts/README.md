...
| Deposit notify (s1-http-public inbound) | `spec/contracts/open-api/orchestration-public.yaml` | `POST /deposits/notify` → 202 + `businessRef` |
...
- [ ] `orchestration-public.yaml` deposit notify returns 202 with `businessRef`
