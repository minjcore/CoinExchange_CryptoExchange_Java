...
- **FR-002**: Document MUST show the full module layout (`core.sharedlib`, `core.wallet`, `core.accounting`, `app-orchestration`, `app-wallet`, `app-accounting`, `app-wallet-worker`) with allowed and forbidden dependency edges.
