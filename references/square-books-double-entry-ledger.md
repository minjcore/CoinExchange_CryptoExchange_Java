...
![Twitter](https://developer.squareup.com/blog/images/twitter-icon.svg)![Facebook](https://developer.squareup.com/blog/images/facebook-icon.svg)![Reddit](https://developer.squareup.com/blog/images/reddit-icon.svg)![LinkedIn](https://developer.squareup.com/blog/images/linkedin-icon.svg)
...
## [problem permalink](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/\#problem) Problem
...
## [solution permalink](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/\#solution) Solution
...
## [double entry accounting primitive permalink](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/\#double-entry-accounting-primitive) Double Entry Accounting Primitive
...
## [modeling double entry accounting in sql permalink](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/\#modeling-double-entry-accounting-in-sql) Modeling Double Entry Accounting in SQL
...
## [summary permalink](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/\#summary) Summary
...
![Picture of Łukasz Strzałkowski](https://images.ctfassets.net/1wryd5vd9xez/hiHfmARlbWNcPBO30ZHzb/d33258550c8951e0f31041d149e5af2c/__ukasz_Strza__kowski.jpeg?w=50&h=50&fl=progressive&q=100&fm=jpg)

**Łukasz Strzałkowski**

#### Tags

[Payments](https://developer.squareup.com/blog/archive/tags/payments/) [Database](https://developer.squareup.com/blog/archive/tags/database/) [Fintech](https://developer.squareup.com/blog/archive/tags/fintech/)

[![Twitter](https://developer.squareup.com/blog/images/twitter-icon.svg)Discuss on Twitter](https://twitter.com/search?q=developer.squareup.com%2Fblog%2Fbooks-an-immutable-double-entry-accounting-database-service) [![Discord](https://developer.squareup.com/blog/images/discord-gray.svg)Join our Discord](https://discord.gg/squaredev)

Table Of Contents

- [Problem](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#problem)
- [Solution](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#solution)
- [Double Entry Accounting Primitive](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#double-entry-accounting-primitive)
- [Modeling Double Entry Accounting in SQL](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#modeling-double-entry-accounting-in-sql)
- [Immutability](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#immutability)
- [Summary](https://developer.squareup.com/blog/books-an-immutable-double-entry-accounting-database-service/#summary)

- [![](https://images.ctfassets.net/1wryd5vd9xez/5ZPHbMtLqsX3dFaLkEpb7P/9dc95382097a49e5259a6a43e2d88d11/https___cdn-images-1.medium.com_max_4002_1_gKwP9vyD1sHstgkycQ2s-w.png?w=750&h=375&q=100&fm=png)\\
\\
![](https://images.ctfassets.net/1wryd5vd9xez/5ZPHbMtLqsX3dFaLkEpb7P/9dc95382097a49e5259a6a43e2d88d11/https___cdn-images-1.medium.com_max_4002_1_gKwP9vyD1sHstgkycQ2s-w.png?w=750&h=375&q=100&fm=png)\\
\\
Engineering \| December 4th, 2018 **Cross-Shard Queries & Lookup Tables** \\
\\
Sharding Cash’s database with Vitess was a massive undertaking that set us up fo...](https://developer.squareup.com/blog/cross-shard-queries-lookup-tables/)
- [![](https://images.ctfassets.net/1wryd5vd9xez/777ADfJDPGOxqWX6Xavi96/319b5ba9f9b311756589748fb2082a8b/https___cdn-images-1.medium.com_1_BaXLipSJ2F6g1kOpkW2dCw.png?w=750&h=375&q=100&fm=png)\\
\\
![](https://images.ctfassets.net/1wryd5vd9xez/777ADfJDPGOxqWX6Xavi96/319b5ba9f9b311756589748fb2082a8b/https___cdn-images-1.medium.com_1_BaXLipSJ2F6g1kOpkW2dCw.png?w=750&h=375&q=100&fm=png)\\
\\
APIs \| December 5th, 2018 **Build a digital wallet only checkout to boost online sales.** \\
\\
Square Payment Form now supports express checkout experiences with digital walle...](https://developer.squareup.com/blog/build-a-digital-wallet-only-checkout-to-boost-online-sales/)

[**View More Articles ›**](https://developer.squareup.com/blog/archive/)
...
[About](https://developer.squareup.com/blog/about/) [Archive](https://developer.squareup.com/blog/archive/) [Privacy Policy](https://squareup.com/legal/general/privacy)

##### Community

[Forums](https://developer.squareup.com/forums) [Discord](https://discord.gg/squaredev) [Twitter](https://twitter.com/squaredev) [Developer Support](https://squareup.com/help/us/en/contact?panel=BF53A9C8EF68)

##### Square Developer

[Home](https://connect.squareup.com/) [Documentation](https://developer.squareup.com/docs) [Work With Us](https://squareup.com/careers)

* * *

© 2026 Square, Inc.

[![Twitter](https://developer.squareup.com/blog/images/twitter-icon-footer.svg)](https://twitter.com/Square)[![Facebook](https://developer.squareup.com/blog/images/facebook-icon-footer.svg)](https://www.facebook.com/square)[![Instagram](https://developer.squareup.com/blog/images/instagram-icon-footer.svg)](https://instagram.com/square)