...
**Related:** [`integration-surfaces.md`](./integration-surfaces.md), [`core.sharedlib.md`](./core.sharedlib.md), [`spec/contracts/open-api/README.md`](../contracts/open-api/README.md).  
...
- Output: `available`, `frozen`, `status` — aligns with public OpenAPI `WalletBalanceData` (schema names in [`spec/contracts/open-api/gtelpay-public.yaml`](../contracts/open-api/gtelpay-public.yaml); wire spec is integration docs).
...
Orchestration order (Application — see [`spec/contracts/open-api/gtelpay-core-internal.yaml`](../contracts/open-api/gtelpay-core-internal.yaml) `createPayment`):
...
Kafka payloads: [`spec/contracts/async-api/core-events.yaml`](../contracts/async-api/core-events.yaml). RabbitMQ full-body envelope (`businessRef`, `memberId`, `messageId`, `payload`): [`spec/contracts/async-api/core-commands.yaml`](../contracts/async-api/core-commands.yaml). Field `businessRef` = column `business_ref`.

### 7.4 Public HTTP

Paths and schemas: [`spec/contracts/open-api/gtelpay-core-internal.yaml`](../contracts/open-api/gtelpay-core-internal.yaml) (orch inbound); public channel [`spec/contracts/open-api/gtelpay-public.yaml`](../contracts/open-api/gtelpay-public.yaml) (paymentorches). Wallet module **does not** embed HTTP routes.
...
**File đã tải:** [`spec/trd/references/wallet/`](./references/wallet/) — mở thư mục, đọc trực tiếp. Không normative; quy tắc nội bộ ở §1–§11 và [`core.sharedlib.md`](./core.sharedlib.md).
