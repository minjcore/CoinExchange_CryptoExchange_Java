...
PAGES = {
    ...
    "claude/confluence/start-here/platform-overview.md":            ("51839264", None),
    "claude/confluence/start-here/wallet-system-in-9-concepts.md":  ("51839571", None),
    ...
    "claude/confluence/contracts-integration/orchestration-public-api.md":      ("51643159", None),
    ...
    # --- specs/011 — Platform Architecture Overview ---
    "specs/011-architecture-overview/confluence-draft.md":          ("51609646", None),
    # --- specs/002 — UC-1 Async Deposit (all subpages) ---
    "specs/002-async-deposit/spec.md":                              ("51315033", None),
    "specs/002-async-deposit/data-model.md":                        ("51544126", None),
    "specs/002-async-deposit/plan.md":                              ("51544148", None),
    "specs/002-async-deposit/tasks.md":                             ("51609677", None),
    "specs/002-async-deposit/data-flow.md":                         ("50987347", None),
    "specs/002-async-deposit/quickstart.md":                        ("50987368", None),
    "specs/002-async-deposit/checklists/adr-prereading.md":         ("51872153", None),
    # --- specs/003-010 — Feature Specs (UC-2 through UC-9) ---
    "specs/003-withdraw/spec.md":                                   ("50332049", None),
    "specs/004-payment/spec.md":                                    ("51609624", None),
    "specs/005-internal-transfer/spec.md":                          ("51544073", None),
    "specs/006-ibft/spec.md":                                       ("50332070", None),
    "specs/007-qr-pos/spec.md":                                     ("51544094", None),
    "specs/008-payroll/spec.md":                                    ("51576861", None),
    "specs/009-disbursement/spec.md":                               ("51315011", None),
    "specs/010-eod-settlement/spec.md":                             ("51183873", None),
    # --- Architecture Decision Records (parent: 51642522) ---
    "adr/ADR-001-immutable-ledger.md":                              ("47972359", None),
    "adr/ADR-002-core-sharedlib.md":                                ("51544266", None),
