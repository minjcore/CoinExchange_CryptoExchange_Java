...
- `core.sharedlib.md` — Part I: `core.sharedlib` shared lib · Part II: accounting fund flow (`coa_*`, §8–16)
...
- `adr/` — ADRs: [001](adr/ADR-001-immutable-ledger.md) ledger, [002](adr/ADR-002-core-foundation-shared-library.md) shared lib = `core.sharedlib`
...
Quick links: [`core.wallet.md`](core.wallet.md) · [`integration-surfaces.md`](integration-surfaces.md) · [`core.sharedlib.md`](core.sharedlib.md) Part I · accounting flow Part II §8–16.
